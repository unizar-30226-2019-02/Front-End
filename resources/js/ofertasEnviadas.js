...
if(tipoOferta = "enviadas"){   //hay que listar las ofertas realizadas

    var url1=dataBase+"/listarOfertasRealizadas?un="+user;  //peticion para listar ofertas realizadas
    Http.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
           ...
           ////alert(listadoOfertasRecibidas.identificador);
            listarOfertasEnviadas(listadoOfertasRecibidas);
        }
    };
    ...
    var url3=dataBase+"/listarOfertasRealizadasAceptadasPendientes?un="+user;  //peticion para listar ofertas recibidas
    Http.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            listadoOfertasRecibidas = prepararListaOfertasRecibidas(this.responseText);
            ////alert(listadoOfertasRecibidas.identificador);
            listarOfertasEnviadasPendientes(listadoOfertasRecibidas);
        }
    };
...
function listarOfertasEnviadas(listaFinal){
    ...
    if(numOfertasRecibidas == 1){
        for(i=0; i < numOfertasRecibidas; i++){
            ...
            ofertaRecibidaHTML = "<li class=\"OF" + listaFinal.identificador + ">" + "\"" +
                ...
                "<button id=\"botonCancelar\" class=\"inline boton\" onclick=\"rechazarOferta(" + listaFinal.identificador + ")\">CANCELAR OFERTA</button>" +
                "<button id=\"botonChat\" class=\"inline boton\" onclick=\"removeItem()\">CHATEAR CON EL VENDEDOR</button>" +
                "</div>" +
                "</div>" +
                "</li>";
            ////alert("OFERTAS nº: " + i + " = " + "\n" + ofertaRecibidaHTML);
        ...
        for(i=0; i < numOfertasRecibidas; i++){
            ...
            ofertaRecibidaHTML = "<li class=\"OF" + listaFinal[i].identificador + ">" + "\"" +
                ...
                "<div id=\"botonesDecision\">" +
                "<button id=\"botonCancelar\" class=\"inline boton\" onclick=\"rechazarOferta(" + listaFinal[i].identificador + ")\">CANCELAR OFERTA</button>" +
                "<button id=\"botonChat\" class=\"inline boton\" onclick=\"removeItem()\">CHATEAR CON EL VENDEDOR</button>" +
                "</div>" +
                "</div>" +
                "</li>";
...
function listarOfertasEnviadasPendientes(listaFinal){
    var ofertaRecibidaHTML = "";
    if(numOfertasRecibidas == 1){
        for(i=0; i < numOfertasRecibidas; i++){
            ////alert("LISTANDO " + numOfertasRecibidas + " OFERTAS");
            ofertaRecibidaHTML = "<li class=\"OF" + listaFinal.identificador + ">" + "\"" +
                ...
                "<div id=\"div_fecha\">" +
                "<p id=\"username\" class=\"inline\">" + listaFinal.vendedor + "</p>" +
                "<p id=\"fecha\" class=\"inline\">" + listaFinal.fecha + "</p>" +
                "</div>" +

                "<div id=\"botonesDecision\">" +
                "<button id=\"botonCancelar\" class=\"inline boton\" onclick=\"reabrirVenta(" + listaFinal.nventa + ")\">CANCELAR COMPRA</button>" +
                "<button id=\"botonChat\" class=\"inline boton\" onclick=\"removeItem()\">CHATEAR CON EL VENDEDOR</button>" +
                "</div>" +
                "</div>" +
                "</li>";
        ...
        for(i=0; i < numOfertasRecibidas; i++){
            ...
            ofertaRecibidaHTML = "<li class=\"OF" + listaFinal[i].identificador + ">" + "\"" +
                ...
                "<div id=\"botonesDecision\">" +
                "<button id=\"botonCancelar\" class=\"inline boton\" onclick=\"reabrirVenta(" + listaFinal[i].nventa + ")\">CANCELAR COMPRA</button>" +
                "<button id=\"botonChat\" class=\"inline boton\" onclick=\"removeItem()\">CHATEAR CON EL VENDEDOR</button>" +
                "</div>" +
                "</div>" +
                "</li>";
